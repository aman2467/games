...
/* to store options entered by both player */
int x_index[5] = {0}, o_index[4] = {0};
 ...
 *
 * @param void
 * @retval int 0 on success otherwise -1
 */
int main(void)
{
	int box_num[9] = {0}, box_index = 0;
...
LOGIC:
		...
		if (((board_array_value[0] == board_array_value[4]) &&
		     (board_array_value[0] == board_array_value[8])) ||
		    ((board_array_value[2] == board_array_value[4]) &&
		     (board_array_value[2] == board_array_value[6]))) {
			display_result(4);
			if (flag == 1) {
				return 0;
			}
...
void display_result(int index)
{
	if (board_array_value[index] == 'X') {
		...
		if (cpu)
			printf(GREEN"CPU HAS WON THE GAME..!!\n\n"RESET);
		else
...
void display_board(void)
{
	...
	for (i = 0, j = 0; i < 2; i++, j += 2) {/* prints first two rows */
		printf(RED"\t %c "RESET"|"RED" %c "RESET"|"RED" %c \n"RESET"\t___|___|___\n",
		       board_array_value[i + j],
		       board_array_value[i + j + 1],
		       board_array_value[i + j + 2]);
	}
	/* prints last row */
	printf(RED"\t %c "RESET"|"RED" %c "RESET"|"RED" %c \n"RESET"\t   |   |   \n",
	       board_array_value[6],
...
int fill_by_cpu(void)
{
	...
	if (cnt == 1) {
		...
		if (x_index[0] % 2 != 0 && x_index[1] % 2 != 0) {/* if both options entered by user are odd */
			/* blocking the user */
			if ((x_index[0] == 1 || x_index[1] == 1) &&
			    (x_index[0] == 3 || x_index[1] == 3)) {
				return index[cnt++];
			}
			if ((x_index[0] == 1 || x_index[1] == 1)&&
			    (x_index[0] == 7 || x_index[1] == 7)) {
				return index[2 + cnt++];
			}
			if ((x_index[0] == 1 || x_index[1] == 1) &&
			    (x_index[0] == 9 || x_index[1] == 9)) {
				return index[cnt++];
			}
			if ((x_index[0] == 3 || x_index[1] == 3) &&
			    (x_index[0] == 9 || x_index[1] == 9)) {
				return index[4 + cnt++];
			}
			if ((x_index[0] == 3 || x_index[1] == 3) &&
		...
		if (x_index[0] % 2 == 0 && x_index[1] % 2 == 0) {/* if both options are even */
			/* blocking the user */
			if ((x_index[0] == 2 || x_index[1] == 2) &&
			    (x_index[0] == 4 || x_index[1] == 4)) {
				return index[-1 + cnt++];
			}
			if ((x_index[0] == 2 || x_index[1] == 2) &&
			    (x_index[0] == 6 || x_index[1] == 6)) {
				return index[1 + cnt++];
			}
			if ((x_index[0] == 4 || x_index[1] == 4) &&
			    (x_index[0] == 6 || x_index[1] == 6)) {
				return index[1 + cnt++];
			}
			if ((x_index[0] == 8 || x_index[1] == 8) &&
			    (x_index[0] == 6 || x_index[1] == 6)) {
				return index[7 + cnt++];
			}
			if ((x_index[0] == 8 || x_index[1] == 8) &&
			...
			if ((x_index[0] == 2 || x_index[1] == 2) &&
			    (x_index[0] == 8 || x_index[1] == 8)) {
				return index[1 + cnt++];
			}
		}
		if (x_index[0] % 2 != 0 && x_index[1] % 2 == 0) {/* if 1st option is odd and 2nd is even */
			/* blocking the user */
			if (((x_index[0] == 1 && x_index[1] == 2) ||
			     (x_index[0] == 1 && x_index[1] == 4)) ||
			    ((x_index[0] == 9 && x_index[1] == 2) ||
			     (x_index[0] == 9 && x_index[1] == 4))) {
				if (x_index[1] == 2)
					return index[1 + cnt++];
				return index[5 + cnt++];
			}
			if (((x_index[0] == 1 && x_index[1] == 6) ||
			     (x_index[0] == 1 && x_index[1] == 8)) ||
			    ((x_index[0] == 9 && x_index[1] == 6) ||
			     (x_index[0] == 9 && x_index[1] == 8))) {
				if (x_index[1] == 6)
					return index[1 + cnt++];
				return index[5 + cnt++];
			}
			if (((x_index[0] == 3 && x_index[1] == 2) ||
			     (x_index[0] == 3 && x_index[1] == 6)) ||
			    ((x_index[0] == 7 && x_index[1] == 2) ||
			     (x_index[0] == 7 && x_index[1] == 6))) {
				if (x_index[1] == 2)
					return index[-1 + cnt++];
				return index[7 + cnt++];
			}
			if (((x_index[0] == 3 && x_index[1] == 4) ||
			     (x_index[0] == 3 && x_index[1] == 8)) ||
			    ((x_index[0] == 7 && x_index[1] == 4) ||
			     (x_index[0] == 7 && x_index[1] == 8))) {
				if (x_index[1] == 4)
					return index[-1 + cnt++];
				return index[7 + cnt++];
			}
		...
		if (x_index[1] % 2 != 0 && x_index[0] % 2 == 0) {/* if 1st option is even and 2nd is odd */
			/* blocking the user */
			if (((x_index[1]==1 && x_index[0]==2) ||
			     (x_index[1]==1 && x_index[0]==4)) ||
			    ((x_index[1]==9 && x_index[0]==2) ||
			     (x_index[1]==9 && x_index[0]==4))) {
				if (x_index[0] == 2)
					return index[1 + cnt++];
				return index[5 + cnt++];
			}
			if (((x_index[1]==1 && x_index[0]==6) ||
			     (x_index[1]==1 && x_index[0]==8)) ||
			    ((x_index[1]==9 && x_index[0]==6) ||
			     (x_index[1]==9 && x_index[0]==8))) {
				if (x_index[0] == 6)
					return index[1 + cnt++];
				return index[5 + cnt++];
			}
			if (((x_index[1]==3 && x_index[0]==2) ||
			     (x_index[1]==3 && x_index[0]==6)) ||
			    ((x_index[1]==7 && x_index[0]==2) ||
			     (x_index[1]==7 && x_index[0]==6))) {
				if (x_index[0] == 2)
					return index[-1 + cnt++];
				return index[7 + cnt++];
			}
			if (((x_index[1]==3 && x_index[0]==4) ||
			     (x_index[1]==3 && x_index[0]==8)) ||
			    ((x_index[1]==7 && x_index[0]==4) ||
			     (x_index[1]==7 && x_index[0]==8))) {
				if (x_index[0] == 4)
					return index[-1 + cnt++];
				return index[7 + cnt++];
			}
	...
	if (cnt >= 2) {
		...
		if (cnt == 3)
			k = 2;/* if CPU last chance */

		/* row-O */
		for (i = 0; i < k; i++) {/* checking for all rows, if CPU can win */
			for (j = 3; j <= 9; j_prev = j, j += 3) {
				if ( rest[i] <= j && rest[i] > j_prev) {
					if ((board_array_value[j - 3] == 'O' &&
					     board_array_value[j - 2] == 'O') ||
					    (board_array_value[j - 3] == 'O' &&
					     board_array_value[j - 1] == 'O') ||
					    (board_array_value[j - 2] == 'O' &&
					     board_array_value[j - 1] == 'O')) {
						cnt++;
						return rest[i];
		...
		for (i = 0; i < k; i++) {/* checking for all columns, if CPU can win */
			for (j = 0; j <= 2; j++) {
				if (rest[i] == j + 1 ||
				    rest[i] == j + 4 ||
				    rest[i] == j + 7 ) {
					if ((board_array_value[j] == 'O' &&
					     board_array_value[j + 3] == 'O') ||
					    (board_array_value[j] == 'O' &&
					     board_array_value[j + 6] == 'O') ||
					    (board_array_value[j + 3] == 'O' &&
					     board_array_value[j + 6] == 'O')) {
						cnt++;
						return rest[i];
		...
		for (i = 0; i < k; i++) {/* checking for rows, if user has a chance to win then block the option */
			for (j = 3; j <= 9;j_prev = j,j += 3) {
				if (rest[i] <= j && rest[i] > j_prev) {
					if ((board_array_value[j - 3] == 'X' &&
					     board_array_value[j - 2] == 'X') ||
					    (board_array_value[j - 3] == 'X' &&
					     board_array_value[j - 1] == 'X') ||
					    (board_array_value[j - 2] == 'X' &&
					     board_array_value[j - 1] == 'X')) {
						cnt++;
						return rest[i];
		...
		for (i = 0; i < k; i++) {/* checking for columns, if user has a chance to win then block the option */
			for (j = 0; j <= 2; j++) {
				if (rest[i] == j + 1 ||
				    rest[i] == j + 4 ||
				    rest[i] == j + 7) {
					if ((board_array_value[j] == 'X' &&
					     board_array_value[j + 3] == 'X') ||
					    (board_array_value[j] == 'X' &&
					     board_array_value[j + 6] == 'X') ||
					    (board_array_value[j + 3] == 'X' &&
					     board_array_value[j + 6] == 'X')) {
						cnt++;
						return rest[i];
